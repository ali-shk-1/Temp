...
function FeesContent() {
  ...
  const [payIsSaving, setPayIsSaving] = useState(false);
  ...
  async function savePayment() {
    // Guard against double-click / double-submit: block re-entry while a
    // save is already in flight for this modal.
    if (payIsSaving) return;
        ...
        <div className="modal">
          ...
          <form ref={payFormRef} onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-success" onClick={savePayment} disabled={payIsSaving}>
                {payIsSaving ? 'Saving…' : paySaveLabel}
              </button>
            </div>
          </form>
        </div>
